        ...
        <div className="grid md:grid-cols-2 gap-12 w-full items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            {sareeCollections.map((item, index) => (
              <div
                key={index}
                className="group relative w-full aspect-[4/5] max-h-[260px] md:max-h-[300px] rounded-xl overflow-hidden cursor-pointer shadow-lg hover:shadow-xl transition"
              >
                {/* Image */}
                <img
                  src={item.img}
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  ...
                  <p className="text-xs text-gray-200">{item.role}</p>
                </div>
              </div>
            ))}
