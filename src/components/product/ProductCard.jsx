    ...
    >
      ...
      <div className="relative h-[260px] overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 right-3 bg-white p-1.5 rounded-full shadow opacity-0 group-hover:opacity-100 transition"
        >
        ...
        <div className="absolute bottom-0 left-0 right-0 translate-y-full group-hover:translate-y-0 transition">
          <button
            onClick={(e) => e.preventDefault()}
            className="w-full bg-black text-white py-2 text-sm flex items-center justify-center gap-2"
          >
